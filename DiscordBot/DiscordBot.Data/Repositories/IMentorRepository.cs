...
namespace DiscordBot.Data.Repositories
{
    ...
    {
        //int GetCount();
        //List<User> GetMentors(int begin, int end);
        ////Task<IEnumerable<Mentor>> GetMentorsAsync();
        //Task<bool?> GetMentorIsMentorHaveLanguageById(ulong id);
        //Task<bool> SetUserProgrammingLanguageAndUserLanguageRolesAsync(ulong userId, ProgrammingLanguages programmingLanguage, Roles role);
